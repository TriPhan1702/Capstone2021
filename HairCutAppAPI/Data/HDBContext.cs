    ...
    public class HDBContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<Staff>().HasData(
                new Staff(){Id = 2, UserId = 2, FullName = "Đặng Trọng Hà", Description = "Đặng Trọng Hà", SalonId = 1, StaffType = GlobalVariables.ManagerRole, HasAutoSchedule = false},
                new Staff(){Id = 3, UserId = 3, FullName = "Phạm Quang Tú", Description = "Phạm Quang Tú", SalonId = 1, StaffType = GlobalVariables.StylistRole, HasAutoSchedule = false},
                new Staff(){Id = 4, UserId = 4, FullName = "Phạm Thụy Trinh", Description = "Phạm Thụy Trinh", SalonId = 1, StaffType = GlobalVariables.BeauticianRole, HasAutoSchedule = false},
                new Staff(){Id = 5, UserId = 5, FullName = "Phạm Nhật Dũng", Description = "Phạm Nhật Dũng", SalonId = 1, StaffType = GlobalVariables.StylistRole, HasAutoSchedule = false},
                new Staff(){Id = 6, UserId = 6, FullName = "Đặng Hà Giang", Description = "Đặng Hà Giang", SalonId = 1, StaffType = GlobalVariables.BeauticianRole, HasAutoSchedule = false},
                new Staff(){Id = 7, UserId = 44, FullName = "Beautician 13", Description = "Beautician 13", SalonId = 1, StaffType = GlobalVariables.BeauticianRole, HasAutoSchedule = false},
                new Staff(){Id = 8, UserId = 45, FullName = "Manager 2", Description = "Manager 2", SalonId = 2, StaffType = GlobalVariables.ManagerRole, HasAutoSchedule = false},
                new Staff(){Id = 9, UserId = 46, FullName = "Stylist 21", Description = "Stylist 21", SalonId = 2, StaffType = GlobalVariables.StylistRole, HasAutoSchedule = false},
                new Staff(){Id = 10, UserId = 47, FullName = "Stylist 22", Description = "Stylist 22", SalonId = 2, StaffType = GlobalVariables.StylistRole, HasAutoSchedule = false},
                new Staff(){Id = 11, UserId = 48, FullName = "Beutician 21", Description = "Beutician 21", SalonId = 2, StaffType = GlobalVariables.BeauticianRole, HasAutoSchedule = false},
                new Staff(){Id = 12, UserId = 49, FullName = "Beautician 22", Description = "Beautician 22", SalonId = 2, StaffType = GlobalVariables.BeauticianRole, HasAutoSchedule = false},
                new Staff(){Id = 13, UserId = 50, FullName = "Manager 3", Description = "Manager 3", SalonId = 3, StaffType = GlobalVariables.ManagerRole, HasAutoSchedule = false},
                new Staff(){Id = 14, UserId = 51, FullName = "Stylist 31", Description = "Stylist 31", SalonId = 3, StaffType = GlobalVariables.StylistRole, HasAutoSchedule = false},
                new Staff(){Id = 15, UserId = 52, FullName = "Stylist 32", Description = "Stylist 32", SalonId = 3, StaffType = GlobalVariables.StylistRole, HasAutoSchedule = false},
                new Staff(){Id = 16, UserId = 53, FullName = "Beutician 31", Description = "Beautician 31", SalonId = 3, StaffType = GlobalVariables.BeauticianRole, HasAutoSchedule = false},
                new Staff(){Id = 17, UserId = 54, FullName = "Beautician 32", Description = "Beautician 32", SalonId = 3, StaffType = GlobalVariables.BeauticianRole, HasAutoSchedule = false},
                new Staff(){Id = 18, UserId = 55, FullName = "Manager 4", Description = "Manager 4", SalonId = 3, StaffType = GlobalVariables.ManagerRole, HasAutoSchedule = false},
                new Staff(){Id = 19, UserId = 56, FullName = "Stylist 41", Description = "Stylist 41", SalonId = 3, StaffType = GlobalVariables.StylistRole, HasAutoSchedule = false},
                new Staff(){Id = 20, UserId = 57, FullName = "Stylist 42", Description = "Stylist 42", SalonId = 3, StaffType = GlobalVariables.StylistRole, HasAutoSchedule = false},
                new Staff(){Id = 21, UserId = 58, FullName = "Beutician 41", Description = "Beautician 41", SalonId = 3, StaffType = GlobalVariables.BeauticianRole, HasAutoSchedule = false},
                new Staff(){Id = 22, UserId = 59, FullName = "Beautician 42", Description = "Beautician 42", SalonId = 3, StaffType = GlobalVariables.BeauticianRole, HasAutoSchedule = false},
                new Staff(){Id = 23, UserId = 60, FullName = "Manager 5", Description = "Manager quan 5", SalonId = 3, StaffType = GlobalVariables.ManagerRole, HasAutoSchedule = false},
                new Staff(){Id = 24, UserId = 61, FullName = "Stylist 51", Description = "Stylist 51", SalonId = 3, StaffType = GlobalVariables.StylistRole, HasAutoSchedule = false},
                new Staff(){Id = 25, UserId = 62, FullName = "Stylist 52", Description = "Stylist 52", SalonId = 3, StaffType = GlobalVariables.StylistRole, HasAutoSchedule = false},
                new Staff(){Id = 26, UserId = 63, FullName = "Beutician 51", Description = "Beautician 51", SalonId = 3, StaffType = GlobalVariables.BeauticianRole, HasAutoSchedule = false},
                new Staff(){Id = 27, UserId = 64, FullName = "Beautician 52", Description = "Beautician 52", SalonId = 3, StaffType = GlobalVariables.BeauticianRole, HasAutoSchedule = false},
                new Staff(){Id = 28, UserId = 65, FullName = "Manager 6", Description = "Manager quan 6", SalonId = 3, StaffType = GlobalVariables.ManagerRole, HasAutoSchedule = false},
                new Staff(){Id = 29, UserId = 66, FullName = "Stylist 61", Description = "Stylist 61", SalonId = 3, StaffType = GlobalVariables.StylistRole, HasAutoSchedule = false},
                new Staff(){Id = 30, UserId = 67, FullName = "Stylist 62", Description = "Stylist 62", SalonId = 3, StaffType = GlobalVariables.StylistRole, HasAutoSchedule = false},
                new Staff(){Id = 31, UserId = 68, FullName = "Beutician 61", Description = "Beautician 61", SalonId = 3, StaffType = GlobalVariables.BeauticianRole, HasAutoSchedule = false},
                new Staff(){Id = 32, UserId = 69, FullName = "Beautician 62", Description = "Beautician 62", SalonId = 3, StaffType = GlobalVariables.BeauticianRole, HasAutoSchedule = false}
            );
