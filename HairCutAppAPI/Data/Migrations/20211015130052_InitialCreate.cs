    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "fb623cb1-83a6-4ca3-a0af-63572c6fb913", "administrator", "ADMINISTRATOR" },
                    { 2, "795f8a17-15ef-46dc-bb01-9bc3ccd1d019", "manager", "MANAGER" },
                    { 3, "cb18912b-fd4f-4af7-a264-00d91d473c05", "stylist", "STYLIST" },
                    { 4, "7af4b007-7564-46ff-8592-1d278bb8f015", "beautician", "BEAUTICIAN" },
                    { 5, "d5a26ab3-9c56-45d8-9cc4-7b08a4d5bec8", "customer", "CUSTOMER" }
                });

            migrationBuilder.InsertData(
                table: "AspNetUsers",
                columns: new[] { "Id", "AccessFailedCount", "AvatarUrl", "ConcurrencyStamp", "Email", "EmailConfirmed", "LockoutEnabled", "LockoutEnd", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "SecurityStamp", "Status", "TwoFactorEnabled", "UserName" },
                values: new object[] { 1, 0, null, "7cb836c0-c293-4b98-8759-91f638014472", "tphan2883@gmail.com", false, false, null, "TPHAN2882@GMAIL.COM", "ADMIN123", "AQAAAAEAACcQAAAAEG4B2iAlQatmxeT3j99y3WN7HQfW16QU2ltLqvGjCchdwnVHV0USO1MLEV7mYHXl7A==", "0869190061", false, "47e60416-4472-4ebc-b02e-86fb6575c761", "Active", false, "admin123" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 5, new DateTime(2021, 10, 15, 20, 0, 52, 141, DateTimeKind.Local).AddTicks(5377), "Cắt Tóc, Ráy Táy", 1, new DateTime(2021, 10, 15, 20, 0, 52, 141, DateTimeKind.Local).AddTicks(5377), "Cắt tóc ráy tai", "active" },
                    { 4, new DateTime(2021, 10, 15, 20, 0, 52, 141, DateTimeKind.Local).AddTicks(5377), "Cắt Tóc, Ráy Táy, Gội Đầu, Rửa Mặt, Dắp mặt", 3, new DateTime(2021, 10, 15, 20, 0, 52, 141, DateTimeKind.Local).AddTicks(5377), "Chăm sóc đầy đử", "active" },
                    { 3, new DateTime(2021, 10, 15, 20, 0, 52, 141, DateTimeKind.Local).AddTicks(5377), "Cắt Tóc Gội Đầu Rửa Mặt", 2, new DateTime(2021, 10, 15, 20, 0, 52, 141, DateTimeKind.Local).AddTicks(5377), "Cắt Tóc Gội Đầu Rửa Mặt", "active" },
                    { 2, new DateTime(2021, 10, 15, 20, 0, 52, 141, DateTimeKind.Local).AddTicks(5377), "Cắt Tóc Gội Đầu", 2, new DateTime(2021, 10, 15, 20, 0, 52, 141, DateTimeKind.Local).AddTicks(5377), "Cắt Tóc Gội Đầu", "active" },
                    { 1, new DateTime(2021, 10, 15, 20, 0, 52, 141, DateTimeKind.Local).AddTicks(5377), "Cắt Tóc", 1, new DateTime(2021, 10, 15, 20, 0, 52, 141, DateTimeKind.Local).AddTicks(5377), "Cắt Tóc", "active" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, null, new DateTime(2021, 10, 15, 20, 0, 52, 141, DateTimeKind.Local).AddTicks(5377), "Salon 1", new DateTime(2021, 10, 15, 20, 0, 52, 141, DateTimeKind.Local).AddTicks(5377), null, null, "Salon 1", "active" },
                    { 2, null, new DateTime(2021, 10, 15, 20, 0, 52, 141, DateTimeKind.Local).AddTicks(5377), "Salon 2", new DateTime(2021, 10, 15, 20, 0, 52, 141, DateTimeKind.Local).AddTicks(5377), null, null, "Salon 2", "active" },
                    { 3, null, new DateTime(2021, 10, 15, 20, 0, 52, 141, DateTimeKind.Local).AddTicks(5377), "Salon 3", new DateTime(2021, 10, 15, 20, 0, 52, 141, DateTimeKind.Local).AddTicks(5377), null, null, "Salon 3", "active" },
                    { 4, null, new DateTime(2021, 10, 15, 20, 0, 52, 141, DateTimeKind.Local).AddTicks(5377), "Salon 4", new DateTime(2021, 10, 15, 20, 0, 52, 141, DateTimeKind.Local).AddTicks(5377), null, null, "Salon 4", "active" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 5, new DateTime(2021, 10, 15, 20, 0, 52, 141, DateTimeKind.Local).AddTicks(5377), "Đắp Mặt", new DateTime(2021, 10, 15, 20, 0, 52, 141, DateTimeKind.Local).AddTicks(5377), "Đắp Mặt", 20000m, "active" },
                    { 4, new DateTime(2021, 10, 15, 20, 0, 52, 141, DateTimeKind.Local).AddTicks(5377), "Gội Đầu", new DateTime(2021, 10, 15, 20, 0, 52, 141, DateTimeKind.Local).AddTicks(5377), "Rửa Mặt", 20000m, "active" },
                    { 1, new DateTime(2021, 10, 15, 20, 0, 52, 141, DateTimeKind.Local).AddTicks(5377), "Cắt tóc", new DateTime(2021, 10, 15, 20, 0, 52, 141, DateTimeKind.Local).AddTicks(5377), "Cắt tóc", 50000m, "active" },
                    { 2, new DateTime(2021, 10, 15, 20, 0, 52, 141, DateTimeKind.Local).AddTicks(5377), "Gội Đầu", new DateTime(2021, 10, 15, 20, 0, 52, 141, DateTimeKind.Local).AddTicks(5377), "Gội Đầu", 20000m, "active" },
                    { 3, new DateTime(2021, 10, 15, 20, 0, 52, 141, DateTimeKind.Local).AddTicks(5377), "Ráy tai", new DateTime(2021, 10, 15, 20, 0, 52, 141, DateTimeKind.Local).AddTicks(5377), "Ráy tai", 10000m, "active" }
                });
