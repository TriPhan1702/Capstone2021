...
namespace HairCutAppAPI.Data.Migrations
{
    ...
    [Migration("20211021081355_InitialCreate3")]
            ...
            modelBuilder.Entity("HairCutAppAPI.Entities.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PasswordHash = new byte[] { 221, 242, 202, 78, 80, 32, 223, 174, 106, 76, 101, 206, 7, 87, 23, 15, 255, 164, 172, 130, 75, 45, 144, 149, 167, 162, 95, 118, 104, 48, 174, 37, 233, 50, 250, 93, 133, 152, 145, 153, 30, 54, 93, 149, 249, 162, 208, 43, 54, 130, 202, 232, 41, 225, 142, 44, 1, 192, 133, 152, 160, 179, 62, 219 },
                            PasswordSalt = new byte[] { 116, 49, 154, 95, 232, 240, 15, 218, 157, 4, 204, 138, 0, 207, 28, 169, 242, 246, 240, 244, 216, 12, 94, 73, 1, 133, 77, 111, 152, 63, 31, 0, 249, 46, 164, 17, 153, 190, 185, 94, 132, 167, 107, 215, 69, 109, 47, 41, 220, 168, 61, 171, 57, 142, 122, 249, 138, 91, 183, 78, 133, 145, 30, 31, 30, 70, 48, 136, 131, 86, 106, 160, 191, 74, 109, 46, 181, 48, 98, 158, 145, 6, 100, 223, 107, 255, 114, 8, 157, 150, 248, 135, 151, 27, 11, 131, 147, 158, 48, 99, 78, 30, 173, 226, 99, 123, 68, 211, 158, 62, 224, 18, 42, 185, 192, 173, 232, 193, 36, 186, 230, 240, 102, 157, 212, 21, 144, 245 },
            ...
            modelBuilder.Entity("HairCutAppAPI.Entities.Combo", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2021, 10, 21, 15, 13, 54, 709, DateTimeKind.Local).AddTicks(1014),
                            Description = "Cắt Tóc",
                            Duration = 1,
                            LastUpdated = new DateTime(2021, 10, 21, 15, 13, 54, 709, DateTimeKind.Local).AddTicks(1014),
                            Name = "Cắt Tóc",
                            Price = 40000m,
                            Status = "active"
                        },
            ...
            modelBuilder.Entity("HairCutAppAPI.Entities.Salon", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2021, 10, 21, 15, 13, 54, 709, DateTimeKind.Local).AddTicks(1014),
                            Description = "Salon 1",
                            LastUpdate = new DateTime(2021, 10, 21, 15, 13, 54, 709, DateTimeKind.Local).AddTicks(1014),
                            Name = "Salon 1",
                            Status = "active"
                        },
                        new
