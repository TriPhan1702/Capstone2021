...
namespace HairCutAppAPI.Data.Migrations
{
    ...
    [Migration("20211120005309_InitialCreate5")]
            ...
            modelBuilder.Entity("HairCutAppAPI.Entities.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PasswordHash = new byte[] { 244, 127, 9, 238, 209, 92, 113, 41, 28, 92, 180, 220, 145, 136, 81, 245, 112, 98, 188, 130, 11, 61, 132, 247, 186, 181, 67, 168, 44, 235, 228, 106, 56, 198, 25, 162, 196, 176, 125, 162, 243, 119, 245, 49, 106, 214, 163, 82, 39, 40, 140, 182, 228, 34, 105, 54, 100, 200, 116, 173, 79, 53, 65, 17 },
                            PasswordSalt = new byte[] { 204, 170, 129, 96, 22, 125, 12, 144, 38, 23, 80, 105, 213, 83, 184, 80, 209, 40, 103, 115, 162, 34, 67, 76, 136, 248, 2, 217, 200, 133, 146, 123, 91, 27, 142, 92, 160, 35, 146, 75, 102, 29, 127, 142, 236, 208, 118, 155, 86, 69, 27, 21, 37, 85, 124, 185, 75, 42, 184, 148, 94, 212, 153, 14, 152, 146, 35, 97, 67, 195, 210, 198, 120, 225, 14, 5, 225, 16, 48, 197, 243, 221, 13, 109, 75, 112, 80, 3, 168, 31, 65, 93, 67, 137, 76, 216, 2, 64, 100, 198, 199, 239, 20, 1, 154, 188, 180, 184, 28, 119, 99, 33, 169, 136, 90, 171, 109, 18, 139, 245, 203, 12, 253, 51, 242, 43, 53, 135 },
            ...
            modelBuilder.Entity("HairCutAppAPI.Entities.Combo", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2021, 11, 20, 7, 53, 9, 373, DateTimeKind.Local).AddTicks(257),
                            Description = "Cắt Tóc",
                            LastUpdated = new DateTime(2021, 11, 20, 7, 53, 9, 373, DateTimeKind.Local).AddTicks(257),
                            Name = "Cắt Tóc",
                            Price = 45000m,
                            Status = "active"
                        },
            ...
            modelBuilder.Entity("HairCutAppAPI.Entities.Salon", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            LastUpdate = new DateTime(2021, 11, 20, 7, 53, 9, 373, DateTimeKind.Local).AddTicks(257),
