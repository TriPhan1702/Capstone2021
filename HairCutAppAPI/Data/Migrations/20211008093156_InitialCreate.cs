    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "5082e688-e7ff-4fa2-b2f8-9c5034bb6c70", "Administrator", "ADMINISTRATOR" },
                    { 2, "71d13a5a-5073-448e-8b11-531e54c2535a", "Manager", "MANAGER" },
                    { 3, "43d8ca1b-c4ce-4fcc-8bf2-33b7f9f1ebb7", "Stylist", "STYLIST" },
                    { 4, "0cbac93f-7d3d-4770-886d-5bd739a3859a", "Beautician", "BEAUTICIAN" },
                    { 5, "c55ed20b-f38f-4872-adf3-3686abd2e2e9", "Customer", "CUSTOMER" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2021, 10, 8, 16, 31, 55, 732, DateTimeKind.Local).AddTicks(1689), "Cắt Tóc", 1, new DateTime(2021, 10, 8, 16, 31, 55, 732, DateTimeKind.Local).AddTicks(1689), "Cắt Tóc", "active" },
                    { 2, new DateTime(2021, 10, 8, 16, 31, 55, 732, DateTimeKind.Local).AddTicks(1689), "Cắt Tóc Gội Đầu", 2, new DateTime(2021, 10, 8, 16, 31, 55, 732, DateTimeKind.Local).AddTicks(1689), "Cắt Tóc Gội Đầu", "active" },
                    { 3, new DateTime(2021, 10, 8, 16, 31, 55, 732, DateTimeKind.Local).AddTicks(1689), "Cắt Tóc Gội Đầu Rửa Mặt", 2, new DateTime(2021, 10, 8, 16, 31, 55, 732, DateTimeKind.Local).AddTicks(1689), "Cắt Tóc Gội Đầu Rửa Mặt", "active" },
                    { 4, new DateTime(2021, 10, 8, 16, 31, 55, 732, DateTimeKind.Local).AddTicks(1689), "Cắt Tóc, Ráy Táy, Gội Đầu, Rửa Mặt, Dắp mặt", 3, new DateTime(2021, 10, 8, 16, 31, 55, 732, DateTimeKind.Local).AddTicks(1689), "Chăm sóc đầy đử", "active" },
                    { 5, new DateTime(2021, 10, 8, 16, 31, 55, 732, DateTimeKind.Local).AddTicks(1689), "Cắt Tóc, Ráy Táy", 1, new DateTime(2021, 10, 8, 16, 31, 55, 732, DateTimeKind.Local).AddTicks(1689), "Cắt tóc ráy tai", "active" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 5, new DateTime(2021, 10, 8, 16, 31, 55, 732, DateTimeKind.Local).AddTicks(1689), "Đắp Mặt", new DateTime(2021, 10, 8, 16, 31, 55, 732, DateTimeKind.Local).AddTicks(1689), "Đắp Mặt", 20000m, "active" },
                    { 3, new DateTime(2021, 10, 8, 16, 31, 55, 732, DateTimeKind.Local).AddTicks(1689), "Ráy tai", new DateTime(2021, 10, 8, 16, 31, 55, 732, DateTimeKind.Local).AddTicks(1689), "Ráy tai", 10000m, "active" },
                    { 4, new DateTime(2021, 10, 8, 16, 31, 55, 732, DateTimeKind.Local).AddTicks(1689), "Gội Đầu", new DateTime(2021, 10, 8, 16, 31, 55, 732, DateTimeKind.Local).AddTicks(1689), "Rửa Mặt", 20000m, "active" },
                    { 1, new DateTime(2021, 10, 8, 16, 31, 55, 732, DateTimeKind.Local).AddTicks(1689), "Cắt tóc", new DateTime(2021, 10, 8, 16, 31, 55, 732, DateTimeKind.Local).AddTicks(1689), "Cắt tóc", 50000m, "active" },
                    { 2, new DateTime(2021, 10, 8, 16, 31, 55, 732, DateTimeKind.Local).AddTicks(1689), "Gội Đầu", new DateTime(2021, 10, 8, 16, 31, 55, 732, DateTimeKind.Local).AddTicks(1689), "Gội Đầu", 20000m, "active" }
                });
