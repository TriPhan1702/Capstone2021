...
namespace HairCutAppAPI.Data.Migrations
{
    ...
    [Migration("20211201152543_InitialCreate13")]
            ...
            modelBuilder.Entity("HairCutAppAPI.Entities.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PasswordHash = new byte[] { 121, 174, 231, 19, 168, 215, 227, 155, 29, 108, 217, 221, 219, 245, 42, 83, 216, 169, 44, 139, 117, 43, 59, 223, 203, 76, 29, 136, 245, 66, 202, 221, 65, 219, 87, 129, 223, 65, 132, 180, 45, 34, 38, 20, 67, 129, 14, 127, 234, 207, 143, 79, 191, 254, 216, 226, 11, 77, 83, 184, 243, 187, 55, 57 },
                            PasswordSalt = new byte[] { 72, 168, 30, 119, 85, 171, 234, 242, 203, 0, 158, 66, 208, 221, 180, 155, 90, 47, 234, 42, 134, 4, 157, 132, 108, 201, 169, 197, 235, 222, 61, 231, 255, 239, 47, 79, 36, 148, 203, 168, 108, 43, 168, 74, 112, 128, 28, 68, 158, 72, 246, 138, 87, 27, 209, 207, 172, 240, 165, 99, 98, 89, 39, 209, 103, 52, 85, 240, 225, 95, 92, 90, 72, 214, 10, 0, 40, 168, 122, 94, 131, 47, 64, 197, 145, 208, 170, 71, 199, 188, 223, 159, 251, 129, 80, 98, 125, 177, 35, 154, 2, 189, 194, 41, 217, 205, 126, 71, 210, 67, 102, 76, 156, 222, 74, 74, 170, 97, 173, 7, 119, 17, 238, 191, 225, 24, 205, 160 },
            ...
            modelBuilder.Entity("HairCutAppAPI.Entities.Combo", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2021, 12, 1, 22, 25, 42, 594, DateTimeKind.Local).AddTicks(594),
                            Description = "Cắt Tóc",
                            LastUpdated = new DateTime(2021, 12, 1, 22, 25, 42, 594, DateTimeKind.Local).AddTicks(594),
                            Name = "Cắt Tóc",
                            Price = 45000L,
                            Status = "active"
                        },
            ...
            modelBuilder.Entity("HairCutAppAPI.Entities.Salon", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            LastUpdate = new DateTime(2021, 12, 1, 22, 25, 42, 594, DateTimeKind.Local).AddTicks(594),
