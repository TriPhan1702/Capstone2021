...
namespace HairCutAppAPI.Data.Migrations
{
    ...
    [Migration("20211116095110_InitialCreate")]
            ...
            modelBuilder.Entity("HairCutAppAPI.Entities.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PasswordHash = new byte[] { 88, 5, 186, 114, 119, 207, 237, 62, 119, 153, 85, 97, 21, 214, 79, 180, 11, 196, 129, 225, 70, 67, 248, 75, 186, 219, 26, 187, 23, 197, 74, 243, 121, 254, 4, 39, 114, 200, 128, 191, 177, 27, 153, 180, 160, 187, 159, 84, 101, 15, 157, 110, 185, 148, 182, 5, 108, 20, 134, 145, 115, 205, 64, 212 },
                            PasswordSalt = new byte[] { 57, 49, 164, 38, 228, 13, 75, 27, 233, 236, 188, 136, 165, 156, 219, 27, 39, 255, 237, 64, 251, 115, 114, 61, 32, 26, 151, 181, 38, 234, 97, 141, 123, 58, 169, 0, 213, 56, 203, 65, 29, 200, 62, 192, 219, 89, 139, 211, 203, 136, 30, 170, 94, 196, 206, 65, 211, 245, 128, 239, 149, 221, 132, 80, 214, 5, 120, 145, 212, 173, 90, 141, 79, 15, 39, 79, 204, 50, 174, 239, 189, 78, 179, 44, 218, 159, 157, 246, 230, 40, 72, 176, 34, 184, 32, 46, 191, 173, 241, 102, 242, 92, 135, 169, 100, 10, 41, 110, 184, 190, 4, 65, 230, 195, 13, 148, 230, 62, 187, 129, 140, 145, 189, 223, 232, 27, 145, 129 },
            ...
            modelBuilder.Entity("HairCutAppAPI.Entities.Combo", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2021, 11, 16, 16, 51, 10, 332, DateTimeKind.Local).AddTicks(3207),
                            Description = "Cắt Tóc",
                            LastUpdated = new DateTime(2021, 11, 16, 16, 51, 10, 332, DateTimeKind.Local).AddTicks(3207),
                            Name = "Cắt Tóc",
                            Price = 45000m,
                            Status = "active"
                        },
            ...
            modelBuilder.Entity("HairCutAppAPI.Entities.Salon", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            LastUpdate = new DateTime(2021, 11, 16, 16, 51, 10, 332, DateTimeKind.Local).AddTicks(3207),
