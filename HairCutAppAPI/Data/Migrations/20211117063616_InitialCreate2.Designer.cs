...
namespace HairCutAppAPI.Data.Migrations
{
    ...
    [Migration("20211117063616_InitialCreate2")]
            ...
            modelBuilder.Entity("HairCutAppAPI.Entities.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PasswordHash = new byte[] { 85, 28, 19, 99, 231, 120, 206, 11, 119, 1, 162, 145, 41, 4, 11, 91, 145, 231, 41, 212, 193, 184, 213, 233, 37, 65, 108, 104, 57, 80, 65, 10, 214, 126, 248, 5, 40, 37, 210, 22, 63, 223, 36, 119, 100, 127, 2, 21, 77, 192, 217, 39, 56, 93, 63, 90, 225, 42, 16, 84, 162, 235, 33, 56 },
                            PasswordSalt = new byte[] { 12, 11, 141, 25, 118, 29, 55, 179, 212, 190, 255, 184, 248, 51, 199, 63, 241, 155, 58, 12, 58, 208, 1, 245, 90, 68, 106, 79, 163, 147, 173, 254, 20, 37, 226, 173, 123, 127, 15, 123, 3, 178, 241, 53, 11, 227, 200, 57, 52, 89, 202, 207, 10, 86, 12, 125, 111, 173, 77, 201, 203, 101, 93, 150, 227, 177, 201, 229, 16, 118, 10, 205, 209, 99, 145, 161, 198, 232, 165, 101, 13, 42, 50, 246, 66, 82, 40, 174, 101, 94, 175, 231, 248, 252, 53, 243, 103, 13, 88, 232, 212, 149, 71, 185, 134, 243, 250, 49, 152, 42, 236, 110, 93, 38, 154, 232, 113, 124, 150, 20, 59, 79, 255, 199, 211, 86, 153, 15 },
            ...
            modelBuilder.Entity("HairCutAppAPI.Entities.Combo", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2021, 11, 17, 13, 36, 16, 186, DateTimeKind.Local).AddTicks(2835),
                            Description = "Cắt Tóc",
                            LastUpdated = new DateTime(2021, 11, 17, 13, 36, 16, 186, DateTimeKind.Local).AddTicks(2835),
                            Name = "Cắt Tóc",
                            Price = 45000m,
                            Status = "active"
                        },
            ...
            modelBuilder.Entity("HairCutAppAPI.Entities.Salon", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            LastUpdate = new DateTime(2021, 11, 17, 13, 36, 16, 186, DateTimeKind.Local).AddTicks(2835),
