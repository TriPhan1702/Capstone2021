...
namespace HairCutAppAPI.Data.Migrations
{
    ...
    [Migration("20211205095100_InitialCreate16")]
            ...
            modelBuilder.Entity("HairCutAppAPI.Entities.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PasswordHash = new byte[] { 230, 137, 196, 45, 3, 151, 184, 247, 100, 213, 38, 61, 4, 116, 124, 25, 138, 44, 190, 51, 25, 19, 115, 247, 142, 220, 214, 141, 239, 125, 194, 123, 63, 166, 154, 58, 93, 83, 221, 0, 15, 254, 63, 12, 179, 250, 114, 103, 75, 252, 51, 228, 245, 254, 145, 226, 213, 107, 212, 135, 12, 3, 56, 195 },
                            PasswordSalt = new byte[] { 224, 72, 32, 160, 156, 188, 231, 61, 228, 4, 208, 143, 233, 44, 187, 175, 229, 151, 38, 166, 37, 179, 196, 75, 200, 97, 8, 5, 215, 130, 79, 35, 124, 111, 189, 122, 199, 223, 175, 26, 137, 6, 188, 44, 110, 227, 143, 243, 170, 137, 55, 213, 181, 81, 62, 231, 253, 233, 246, 37, 166, 19, 101, 135, 195, 78, 140, 43, 139, 62, 31, 123, 10, 156, 251, 99, 57, 127, 245, 94, 85, 20, 79, 179, 11, 252, 108, 188, 110, 115, 64, 24, 149, 142, 63, 70, 83, 39, 188, 177, 255, 104, 79, 28, 104, 77, 3, 108, 200, 236, 74, 181, 138, 229, 172, 188, 83, 56, 157, 97, 12, 126, 186, 71, 166, 170, 54, 94 },
            ...
            modelBuilder.Entity("HairCutAppAPI.Entities.Combo", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2021, 12, 5, 16, 51, 0, 83, DateTimeKind.Local).AddTicks(9351),
                            Description = "Cắt Tóc",
                            LastUpdated = new DateTime(2021, 12, 5, 16, 51, 0, 83, DateTimeKind.Local).AddTicks(9351),
                            Name = "Cắt Tóc",
                            Price = 45000L,
                            Status = "active"
                        },
            ...
            modelBuilder.Entity("HairCutAppAPI.Entities.Salon", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            LastUpdate = new DateTime(2021, 12, 5, 16, 51, 0, 83, DateTimeKind.Local).AddTicks(9351),
